...
<p align="center">
  <strong>COM自動化によるPowerPointのリアルタイム制御 —<br>AIエージェントと開発者のための150ツールを備えたMCPサーバー</strong>
</p>
...
- **26カテゴリ・150ツール** — スライド、シェイプ、テキスト、テーブル、グラフ、アニメーション、SmartArt、メディア、フリーフォームパスなど
...
| **アニメーション** | 6 | トランジション、アニメーション追加/一覧/更新/削除/全削除（入口・退出・強調・モーションパス対応） |
